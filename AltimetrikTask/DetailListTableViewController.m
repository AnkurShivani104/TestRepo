...
@interface DetailListTableViewController ()

@end

@implementation DetailListTableViewController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = strUsername;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    cell.textLabel.text = @"title text - static";
    cell.detailTextLabel.text = @"sub title text - Static";
